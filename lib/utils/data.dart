...
List<ListTileSingleNodeModel> sampleNodes = [
  ListTileSingleNodeModel(
    ...
    title: "Get grocerries from the market sometimes it is hard to face reality and even tho i might get mad at you dont be afraid to stand alone sometimes its the best it ",
    index: 2,
  ),
