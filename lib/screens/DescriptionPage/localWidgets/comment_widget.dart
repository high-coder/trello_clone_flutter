              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("Deepak Mittal",style: GoogleFonts.openSans(color: ourWhite,fontSize: 15),),
                  ),
                  Container(
                  ...
                  Text("${widget.commentThing.dateTime}",style: GoogleFonts.poppins(color: ourWhite,fontSize: 15))
                ],
              ),
            ),
          )
